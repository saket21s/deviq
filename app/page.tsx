...
function PracticePage({ user, profile, tk, isMobile, onProfileSave, dark }: {
  ...
  const defaultCompanies: CompanyInfo[] = [
    { name: "Google", slug: "google", icon: "G", tier: "FAANG", logo: "https://www.gstatic.com/images/branding/product/1x/googleg_48dp.png" },
    { name: "Amazon", slug: "amazon", icon: "A", tier: "FAANG", logo: "https://m.media-amazon.com/images/S/amazon-icons-v2/icon_amazon.svg" },
    { name: "Meta", slug: "facebook", icon: "M", tier: "FAANG", logo: "https://static.xx.fbcdn.net/rsrc.php/y1/r/4lCZIS5sv3d.png" },
    { name: "Apple", slug: "apple", icon: "Ap", tier: "FAANG", logo: "https://www.apple.com/ac/structured-data/images/open_graph_logo.png" },
    { name: "Netflix", slug: "netflix", icon: "N", tier: "FAANG", logo: "https://help.netflix.com/en/media/netflix_logo_red_1.png" },
    { name: "Microsoft", slug: "microsoft", icon: "Ms", tier: "FAANG", logo: "https://c.s-microsoft.com/favicon.ico" },
    { name: "Bloomberg", slug: "bloomberg", icon: "Bl", tier: "Top", logo: "https://assets.bloombergqa.com/images/logo.png" },
    { name: "Goldman Sachs", slug: "goldman-sachs", icon: "GS", tier: "Top", logo: "https://www.goldmansachs.com/favicon.ico" },
    { name: "Uber", slug: "uber", icon: "Ub", tier: "Top", logo: "https://www.uber-assets.com/image/upload/v1534085869/site-favicon-white-green_200x200.png" },
    { name: "LinkedIn", slug: "linkedin", icon: "Li", tier: "Top", logo: "https://static.licdn.com/aero-v1/sc/h/ckjoy43262nligpy159owyx4o" },
    { name: "Adobe", slug: "adobe", icon: "Ad", tier: "Top", logo: "https://www.adobe.com/favicon.ico" },
    { name: "Oracle", slug: "oracle", icon: "Or", tier: "Top", logo: "https://www.oracle.com/favicon.ico" },
    { name: "Salesforce", slug: "salesforce", icon: "Sf", tier: "Top", logo: "https://www.salesforce.com/favicon.ico" },
    { name: "Twitter", slug: "twitter", icon: "Tw", tier: "Top", logo: "https://pbs.twimg.com/profile_images/942858479592554497/BbazLO9L_400x400.jpg" },
    { name: "Spotify", slug: "spotify", icon: "Sp", tier: "Mid", logo: "https://www.scdn.co/i/_global/open-graph-default.png" },
    { name: "Stripe", slug: "stripe", icon: "St", tier: "Mid", logo: "https://stripe.com/favicon.ico" },
    { name: "Airbnb", slug: "airbnb", icon: "Ab", tier: "Mid", logo: "https://www.airbnb.com/favicon.ico" },
    { name: "Snap", slug: "snapchat", icon: "Sn", tier: "Mid", logo: "https://www.snapchat.com/favicon.ico" },
    { name: "TikTok", slug: "tiktok", icon: "Tk", tier: "Mid", logo: "https://www.tiktok.com/favicon.ico" },
    { name: "Nvidia", slug: "nvidia", icon: "Nv", tier: "Mid", logo: "https://www.nvidia.com/favicon.ico" },
    { name: "PayPal", slug: "paypal", icon: "Pp", tier: "Mid", logo: "https://www.paypal.com/favicon.ico" },
    { name: "Cisco", slug: "cisco", icon: "Cs", tier: "Mid", logo: "https://www.cisco.com/favicon.ico" },
    { name: "VMware", slug: "vmware", icon: "Vm", tier: "Mid", logo: "https://www.vmware.com/favicon.ico" },
    { name: "Walmart", slug: "walmart", icon: "Wm", tier: "Mid", logo: "https://www.walmart.com/favicon.ico" },
    { name: "JPMorgan", slug: "jpmorgan", icon: "JP", tier: "Mid", logo: "https://www.jpmorganchase.com/favicon.ico" },
    { name: "Samsung", slug: "samsung", icon: "Sm", tier: "Mid", logo: "https://www.samsung.com/favicon.ico" },
    { name: "Intuit", slug: "intuit", icon: "In", tier: "Mid", logo: "https://www.intuit.com/favicon.ico" },
    { name: "Yahoo", slug: "yahoo", icon: "Ya", tier: "Mid", logo: "https://www.yahoo.com/favicon.ico" },
  ];
