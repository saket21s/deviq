...
function PracticePage({ user, profile, tk, isMobile, onProfileSave, dark }: {
  ...
  const defaultCompanies: CompanyInfo[] = [
    ...
    { name: "Twitter", slug: "twitter", icon: "Tw", tier: "Top", logo: "https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/twitter.svg", bgColor: "#000000" },
    ...
    { name: "JPMorgan", slug: "jpmorgan", icon: "JP", tier: "Mid", logo: "https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/jpmorganchase.svg", bgColor: "#117DBA" },
