...
function PracticePage({ user, profile, tk, isMobile, onProfileSave, dark }: {
  ...
  const defaultCompanies: CompanyInfo[] = [
    ...
    { name: "Amazon", slug: "amazon", icon: "A", tier: "FAANG", logo: "https://a0.awsstatic.com/libra-css/images/logos/aws_logo_smile_1200x630_300dpi.png" },
    { name: "Meta", slug: "facebook", icon: "M", tier: "FAANG", logo: "https://www.meta.com/favicon.ico" },
    { name: "Apple", slug: "apple", icon: "Ap", tier: "FAANG", logo: "https://www.apple.com/favicon.ico" },
    { name: "Netflix", slug: "netflix", icon: "N", tier: "FAANG", logo: "https://www.netflix.com/favicon.ico" },
    { name: "Microsoft", slug: "microsoft", icon: "Ms", tier: "FAANG", logo: "https://www.microsoft.com/favicon.ico" },
    { name: "Bloomberg", slug: "bloomberg", icon: "Bl", tier: "Top", logo: "https://www.bloomberg.com/favicon.ico" },
    { name: "Goldman Sachs", slug: "goldman-sachs", icon: "GS", tier: "Top", logo: "https://www.goldmansachs.com/favicon.ico" },
    { name: "Uber", slug: "uber", icon: "Ub", tier: "Top", logo: "https://www.uber.com/favicon.ico" },
    { name: "LinkedIn", slug: "linkedin", icon: "Li", tier: "Top", logo: "https://www.linkedin.com/favicon.ico" },
    ...
    { name: "Twitter", slug: "twitter", icon: "Tw", tier: "Top", logo: "https://www.twitter.com/favicon.ico" },
    { name: "Spotify", slug: "spotify", icon: "Sp", tier: "Mid", logo: "https://www.spotify.com/favicon.ico" },
    { name: "Stripe", slug: "stripe", icon: "St", tier: "Mid", logo: "https://www.stripe.com/favicon.ico" },
    { name: "Airbnb", slug: "airbnb", icon: "Ab", tier: "Mid", logo: "https://www.airbnb.com/favicon.ico" },
    { name: "Snap", slug: "snapchat", icon: "Sn", tier: "Mid", logo: "https://www.snap.com/favicon.ico" },
