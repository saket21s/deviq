...
function PracticePage({ user, profile, tk, isMobile, onProfileSave, dark }: {
  ...
  const defaultCompanies: CompanyInfo[] = [
    { name: "Google", slug: "google", icon: "G", tier: "FAANG", logo: "https://icons.duckduckgo.com/ip3/google.com.ico", bgColor: "#4285F4" },
    { name: "Amazon", slug: "amazon", icon: "A", tier: "FAANG", logo: "https://icons.duckduckgo.com/ip3/amazon.com.ico", bgColor: "#FF9900" },
    { name: "Meta", slug: "meta", icon: "M", tier: "FAANG", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/meta.svg", bgColor: "#1877F2" },
    { name: "Apple", slug: "apple", icon: "Ap", tier: "FAANG", logo: "https://icons.duckduckgo.com/ip3/apple.com.ico", bgColor: "#000000" },
    { name: "Netflix", slug: "netflix", icon: "N", tier: "FAANG", logo: "https://icons.duckduckgo.com/ip3/netflix.com.ico", bgColor: "#E50914" },
    { name: "Microsoft", slug: "microsoft", icon: "Ms", tier: "FAANG", logo: "https://icons.duckduckgo.com/ip3/microsoft.com.ico", bgColor: "#0078D4" },
    { name: "Bloomberg", slug: "bloomberg", icon: "Bl", tier: "Top", logo: "https://icons.duckduckgo.com/ip3/bloomberg.com.ico", bgColor: "#000000" },
    { name: "Goldman Sachs", slug: "goldman-sachs", icon: "GS", tier: "Top", logo: "https://icons.duckduckgo.com/ip3/goldmansachs.com.ico", bgColor: "#003DA5" },
    { name: "Uber", slug: "uber", icon: "Ub", tier: "Top", logo: "https://icons.duckduckgo.com/ip3/uber.com.ico", bgColor: "#000000" },
    { name: "LinkedIn", slug: "linkedin", icon: "Li", tier: "Top", logo: "https://icons.duckduckgo.com/ip3/linkedin.com.ico", bgColor: "#0A66C2" },
    ...
    { name: "Twitter", slug: "twitter", icon: "Tw", tier: "Top", logo: "https://raw.githubusercontent.com/tandpfun/skill-icons/main/icons/Twitter.svg", bgColor: "#000000" },
    ...
    { name: "Snap", slug: "snap", icon: "Sn", tier: "Mid", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/snapchat.svg", bgColor: "#FFFC00" },
    { name: "TikTok", slug: "tiktok", icon: "Tk", tier: "Mid", logo: "https://icons.duckduckgo.com/ip3/tiktok.com.ico", bgColor: "#000000" },
    { name: "Nvidia", slug: "nvidia", icon: "Nv", tier: "Mid", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/nvidia.svg", bgColor: "#76B900" },
    { name: "PayPal", slug: "paypal", icon: "Pp", tier: "Mid", logo: "https://icons.duckduckgo.com/ip3/paypal.com.ico", bgColor: "#003087" },
          ...
          {filteredCompanyList.map(c => {
            ...
            return (
              <button key={c.slug} onClick={() => { setSelectedCompany(c.slug); fetchCompanyProblems(c.slug); }} style={{
                ...
                <div style={{ width: 40, height: 40, borderRadius: 6, background: c.bgColor || tk.surface, display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 6, overflow: "hidden" }}>
                  {c.logo && !failedLogos.has(c.logo) ? (
                    <img src={c.logo} alt={c.name} onError={() => handleLogoError(c.logo!)} style={{ width: "100%", height: "100%", objectFit: "contain", padding: "4px" }} />
                  ) : (
            ...
            <div style={{ padding: "16px 20px", background: tk.bgAlt, borderBottom: `1px solid ${tk.border}`, display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap" as const, gap: 12 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                ...
                {(() => {
                  ...
                  if (info) {
                    return <div style={{ width: 48, height: 48, borderRadius: 6, background: info.bgColor || tk.surface, display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden" }}>
                      {info.logo && !failedLogos.has(info.logo) ? (
                        <img src={info.logo} alt={info.name} onError={() => handleLogoError(info.logo!)} style={{ width: "100%", height: "100%", objectFit: "contain", padding: "4px" }} />
                      ) : (
      ...
      <div suppressHydrationWarning style={{ minHeight: "100vh", background: tk.bg, color: tk.text, fontFamily: "'Geist', system-ui, sans-serif", transition: "background 0.2s, color 0.2s" }}>
        ...
        <nav suppressHydrationWarning style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 200, background: "transparent", padding: isMobile ? "10px 12px 0" : isTablet ? "14px 16px 0" : "14px 96px 0 16px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: isMobile ? 8 : isTablet ? 10 : 30, height: isMobile ? 48 : isTablet ? 56 : 50, padding: isMobile ? "0 8px 0 18px" : isTablet ? "0 12px 0 22px" : "0 8px 0 24px", margin: "0 auto", width: isMobile || isTablet ? "100%" : "auto", maxWidth: isMobile || isTablet ? "100%" : "fit-content", background: dark ? "rgba(26,26,26,0.72)" : "rgba(255,255,255,0.62)", backdropFilter: "blur(24px) saturate(180%)", WebkitBackdropFilter: "blur(24px) saturate(180%)", border: dark ? "1px solid rgba(255,255,255,0.06)" : "1px solid rgba(255,255,255,0.85)", borderRadius: 999, boxShadow: dark ? "0 4px 20px rgba(0,0,0,0.4), inset 0 0.5px 0 rgba(255,255,255,0.05)" : "0 4px 20px rgba(0,0,0,0.04), inset 0 0.5px 0 rgba(255,255,255,0.72)", willChange: "width", backfaceVisibility: "hidden" }}>
            <button onClick={() => navigate("home")} style={{ fontSize: isMobile ? 17 : isTablet ? 19 : 17, fontWeight: 700, color: tk.text, letterSpacing: "-0.03em", background: "none", border: "none", cursor: "pointer", padding: 0, flexShrink: 0, display: "flex", alignItems: "center" }}>DevIQ<span style={{ color: tk.purple }}>.</span></button>
            {!isMobile && !isTablet && (
