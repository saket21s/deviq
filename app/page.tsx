...
function PracticePage({ user, profile, tk, isMobile, onProfileSave, dark }: {
  ...
  const defaultCompanies: CompanyInfo[] = [
    ...
    { name: "Meta", slug: "facebook", icon: "M", tier: "FAANG", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/meta.svg", bgColor: "#1877F2" },
    ...
    { name: "Snap", slug: "snapchat", icon: "Sn", tier: "Mid", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/snapchat.svg", bgColor: "#FFFC00" },
    ...
    { name: "JPMorgan", slug: "jpmorgan", icon: "JP", tier: "Mid", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/jpmorganchase.svg", bgColor: "#117DBA" },
